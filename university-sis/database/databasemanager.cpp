...
void DatabaseManager::seedSampleData()
{
    ...
    // Seed Grades (comprehensive mock data for all students and courses)
    query.exec("INSERT INTO grades (student_id, course_id, a1, a2, final_exam, total) VALUES "
               // Student 1 (أحمد محمد علي) - Computer Science courses
               "(1, 1, 'A', 'B+', 'A', 'A'), (1, 2, 'B', 'B+', 'A-', 'B+'), (1, 14, 'A-', 'A', 'A', 'A'), "
               "(1, 10, 'B+', 'A-', 'A-', 'A-'), (1, 12, 'A', 'A-', 'B+', 'A-'), (1, 13, 'B+', 'B+', 'A-', 'B+'), "
               // Student 2 (فاطمة حسن إبراهيم) - Mathematics courses  
               "(2, 3, 'B+', 'B', 'A', 'B+'), (2, 6, 'A', 'A-', 'A', 'A'), (2, 9, 'B', 'B+', 'B+', 'B+'), "
               "(2, 5, 'A-', 'A', 'A-', 'A-'), (2, 1, 'B+', 'B', 'B+', 'B+'), "
               // Student 3 (محمد خالد أحمد) - Physics courses
               "(3, 7, 'A-', 'A', 'A-', 'A-'), (3, 8, 'B+', 'B', 'B+', 'B+'), (3, 1, 'B', 'B+', 'B', 'B+'), "
               "(3, 5, 'A-', 'B+', 'A-', 'A-'), (3, 11, 'B+', 'B', 'B+', 'B+'), "
               // Student 4 (سارة علي محمود) - Computer Science (top student)
               "(4, 1, 'A', 'A', 'A', 'A'), (4, 2, 'A-', 'A', 'A-', 'A-'), (4, 4, 'A', 'A-', 'A', 'A'), "
               "(4, 10, 'B+', 'A-', 'A-', 'A-'), (4, 12, 'A', 'A', 'A-', 'A'), (4, 14, 'A-', 'A', 'A', 'A'), "
               "(4, 13, 'A', 'A-', 'A-', 'A-'), (4, 15, 'A', 'A-', 'A', 'A'), "
               // Student 5 (عمر يوسف عبدالله) - Engineering courses
               "(5, 1, 'B+', 'A-', 'B+', 'A-'), (5, 5, 'A', 'A', 'A', 'A'), (5, 14, 'B', 'B+', 'A-', 'B+'), "
               "(5, 2, 'B+', 'B', 'B+', 'B+'), (5, 12, 'A-', 'B+', 'A-', 'A-'), (5, 20, 'B+', 'B+', 'B+', 'B+'), "
               // Student 6 (مريم سالم حسين) - Biology courses
               "(6, 9, 'A-', 'A', 'A', 'A'), (6, 12, 'B+', 'B+', 'A-', 'B+'), (6, 1, 'B', 'B+', 'B+', 'B+'), "
               "(6, 7, 'A-', 'A-', 'A-', 'A-'), (6, 8, 'B+', 'A-', 'B+', 'B+'), "
               // Student 7 (يوسف أحمد إسماعيل) - Chemistry courses
               "(7, 7, 'B', 'B+', 'B', 'B+'), (7, 8, 'B+', 'B', 'B+', 'B+'), (7, 1, 'C+', 'B', 'B-', 'B-'), "
               "(7, 5, 'B', 'B-', 'B', 'B-'), (7, 9, 'B-', 'B', 'B-', 'B-'), "
               // Student 8 (نورا محمد عبدالرحمن) - Mathematics (top student)
               "(8, 3, 'A', 'A-', 'A', 'A'), (8, 6, 'A', 'A', 'A', 'A'), (8, 1, 'A-', 'A', 'A-', 'A'), "
               "(8, 5, 'A', 'A-', 'A', 'A'), (8, 2, 'A-', 'A', 'A-', 'A-'), (8, 9, 'A', 'A', 'A-', 'A'), "
               // Student 9 (خالد محمود سعيد) - Computer Science
               "(9, 1, 'A-', 'A', 'A-', 'A'), (9, 2, 'B+', 'A-', 'A-', 'A-'), (9, 14, 'A', 'A-', 'A', 'A'), "
               "(9, 10, 'B+', 'B+', 'A-', 'B+'), (9, 12, 'A-', 'A-', 'B+', 'A-'), (9, 13, 'B+', 'A-', 'B+', 'B+'), "
               // Student 10 (ليلى أحمد فؤاد) - Engineering
               "(10, 1, 'B+', 'A-', 'B+', 'A-'), (10, 5, 'A', 'A-', 'A', 'A'), (10, 14, 'B+', 'B+', 'A-', 'B+'), "
               "(10, 2, 'B', 'B+', 'B+', 'B+'), (10, 8, 'A-', 'B+', 'A-', 'A-'), (10, 20, 'B+', 'B', 'B+', 'B+')");
